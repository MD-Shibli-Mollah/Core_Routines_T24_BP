...
* @ValidationInfo : Copyright Temenos Headquarters SA 1993-2021. All rights reserved.
    ...
    SUBROUTINE SAMPLE.SET.RESTRICTION.TYPE.BI(iInputHook, oRestrictionDetails, oHookError)
*-----------------------------------------------------------------------------
...
* Process
*
CALL TPSLogging("Start","SAMPLE HOOK BI","","")
    CALL TPSLogging("Input Parameter","SAMPLE HOOK BI","iInputHook: <":iInputHook:">","")
...
CALL TPSLogging("Output Parameter","SAMPLE HOOK BI","oRestrictionDetails: <":oRestrictionDetails:">","")

CALL TPSLogging("Output Parameter","SAMPLE HOOK BI","oHookError: <":oHookError:">","")
...
*  Check the restriction type 'DEBIT'
    IF rPostingRestriction<AC.POS.RESTRICTION.TYPE> EQ 'DEBIT' THEN
        ...
        END ELSE
            debitRestrictType = rPostingRestriction<AC.POS.RESTRICTION.TYPE>:'-Warning'
