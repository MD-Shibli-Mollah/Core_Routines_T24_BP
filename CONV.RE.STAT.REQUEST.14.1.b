...
*-----------------------------------------------------------------------------
    $PACKAGE RE.Config
      SUBROUTINE CONV.RE.STAT.REQUEST.14.1
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.RE.STAT.REQUEST"        ; * File to be converted
      COMPANY.CODE.POS = 18              ; * Position of XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 7                 ; * Position to add from.
...
*
      ...
      IF TEXT EQ "Y" THEN
         ...
         IF MULTI.COMPANY.FILE THEN
            SSELECT F.COMPANY
            END.OF.COMPANIES = FALSE
            LOOP
               READNEXT K.COMPANY ELSE END.OF.COMPANIES = TRUE
            UNTIL END.OF.COMPANIES
