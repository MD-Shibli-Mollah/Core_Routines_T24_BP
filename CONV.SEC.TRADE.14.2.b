...
*-----------------------------------------------------------------------------
    $PACKAGE SC.SctTrading
      SUBROUTINE CONV.SEC.TRADE.14.2
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.SEC.TRADE"              ; * File to be converted
      COMPANY.CODE.POS = "114"           ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
** file is being converted more than once.
      ...
      ADD.FIELD<1,2> = "54"              ; * Position to add from. (New field number)
      ADD.FIELD<2,2> = "5"               ; * Number of fields to add.
      ADD.FIELD<1,3> = "35"              ; * Position to add from. (New field number)
      ADD.FIELD<2,3> = "1"               ; * Number of fields to add.
*
*************************************************************************
*
