* @ValidationCode : MjoxNzM1NDMyMzMxOkNwMTI1MjoxNTcxNzM3Mzg3Mjg0OnN1ZGhhcmFtZXNoOi0xOi0xOjA6MTpmYWxzZTpOL0E6REVWXzIwMTkxMC4yMDE5MDkyMC0wNzA3Oi0xOi0x
...
*-----------------------------------------------------------------------------
    ...
    SUBROUTINE AA.ARR.TC.PRIVILEGES
*-----------------------------------------------------------------------------
* Properties and Methods for AA.ARR.TC.PRIVILEGES
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
    tmp=EB.Template.getCProperties(); tmp<EB.Template.PTitle>='AA Arrangement -TC Privileges'; EB.Template.setCProperties(tmp);* Screen title
...
*
    ...
    EB.SystemTables.setApplication('AA.ARR.TC.PRIVILEGES')
*
