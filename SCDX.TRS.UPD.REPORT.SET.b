* @ValidationCode : MjotMTI4NDY5Nzg3OTpDcDEyNTI6MTYwNDgzNzUwMTU3MDpyZGVlcGlnYToxOjA6MDoxOmZhbHNlOk4vQTpERVZfMjAyMDA5LjIwMjAwODI4LTE2MTc6Njo2
...
SUBROUTINE SCDX.TRS.UPD.REPORT.SET(TXN.ID,TXN.REC,TXN.DATA,RET.VAL)
*-----------------------------------------------------------------------------
* This routine to update the REPORT.SET as ARM in SCDX.ARM.MIFID.DATA
...
*-----------------------------------------------------------------------------
    ...
    GOSUB PROCESS       ; *Process to update the REPORT.SET as ARM for SCDX.ARM.MIFID.DATA reports
...
*** <region name= PROCESS>
PROCESS:
*** <desc>Process to update the REPORT.SET as ARM for SCDX.ARM.MIFID.DATA reports </desc>
