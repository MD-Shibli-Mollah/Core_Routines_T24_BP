* @ValidationCode : MjoxOTk5NDA0MDYwOkNwMTI1MjoxNTk5NDc2MjI1NTY4OmtiaGFyYXRocmFqOjU6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDguMjAyMDA3MzEtMTE1MTo1NTo1NQ==
* @ValidationInfo : Timestamp         : 07 Sep 2020 16:27:05
...
SUBROUTINE OC.UPD.BUY.DOB(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
*-----------------------------------------------------------------------------
*<Routine description>
*
* Populate the value only when MIFID.REPORT.STATUS as "NEWT".
* Attached as a link routine in TX.TXN.BASE.MAPPING record to
* If NATIONAL.ID is populated in field BUYER.ID then fetch BIRTH.INCORP.DATE from CUSTOMER table for the counterparty
* Incoming parameters:
*
