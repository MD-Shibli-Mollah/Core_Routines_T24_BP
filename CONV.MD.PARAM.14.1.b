...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.MD.PARAMETER"           ; * File to be converted
...
*
      ...
      IF TEXT EQ "Y" THEN
         ...
         IF MULTI.COMPANY.FILE THEN
            ...
            LOOP
               REMOVE K.COMPANY FROM COMP.LIST SETTING RCOMP$
            WHILE K.COMPANY:RCOMP$
...
*
            ...
            REPEAT
*
            IF YREC<30> = "" THEN YREC<30> = "30C"           ; * Default 1 month
