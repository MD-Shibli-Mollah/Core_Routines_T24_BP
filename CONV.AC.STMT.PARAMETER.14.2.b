* @ValidationCode : Mjo0NTE0NjQ5NDg6Q3AxMjUyOjE1NjQ1NjMyMjI2ODQ6c3JhdmlrdW1hcjotMTotMTowOi0xOmZhbHNlOk4vQTpERVZfMjAxOTA3LjIwMTkwNjEyLTAzMjE6LTE6LTE=
...
SUBROUTINE CONV.AC.STMT.PARAMETER.14.2
*
...
*
    ...
    NEXT X
    CLS := @(0,4)
    YFILE = "F.AC.STMT.PARAMETER"      ; * File to be converted
    COMPANY.CODE.POS = 14              ; * Position of new XX.CO.CODE in the file
    F.PGM.FILE = ''
...
*
    ...
    ETEXT ="AC.RTN.WHY.PROGRAM.ABORTED"          ; * Used to update F.CONVERSION.PGMS
    CALL PGM.BREAK
*
*************************************************************************
END
