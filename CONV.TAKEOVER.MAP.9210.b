...
*-----------------------------------------------------------------------------
    $PACKAGE EB.SystemTables
      SUBROUTINE CONV.TAKEOVER.MAP.9210
*
...
**************************************************************
* SUBROUTINE TO CONVERT EXISTING TAKEOVER.MAPPING RECORDS.
* ALSO ADD NEW FIELDS :-
...
***************
      ...
      WHILE K.TAKEOVER.MAPPING DO
         ...
         IF NO.OF.FIELDS < 25 THEN
            INS '' BEFORE R.TAKEOVER.MAPPING<10>
            INS '' BEFORE R.TAKEOVER.MAPPING<10>
            INS '' BEFORE R.TAKEOVER.MAPPING<15>
         END
...
************
      TEXT = E
      CALL FATAL.ERROR('CONV.TAKEOVER.MAPPING.9011')
   END
