...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.DIARY"                  ; * File to be converted
      ORIGINAL.FILE = YFILE              ; * Store this it will changed
      COMPANY.CODE.POS = "104"           ; * Position of new XX.CO.CODE in the file
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "93"              ; * Position to add from. (New field number)
