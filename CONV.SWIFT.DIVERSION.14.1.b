...
* Version 4 31/05/01  GLOBUS Release No. 200511 31/10/05
*-----------------------------------------------------------------------------
* <Rating>531</Rating>
*-----------------------------------------------------------------------------
    $PACKAGE DE.Config
      SUBROUTINE CONV.SWIFT.DIVERSION.14.1
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.DE.SWIFT.DIVERSION"     ; * File to be converted
      COMPANY.CODE.POS = 19              ; * Position of XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 8                 ; * Position to add from.
