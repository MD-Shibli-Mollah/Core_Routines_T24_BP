...
* Version 5 07/06/01  GLOBUS Release No. 200511 31/10/05
*-----------------------------------------------------------------------------
* <Rating>531</Rating>
*-----------------------------------------------------------------------------
    $PACKAGE EB.SystemTables
      SUBROUTINE CONV.SPF.14.1
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.SPF"                    ; * File to be converted
      COMPANY.CODE.POS = 41              ; * Position of XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 27                ; * Position to add from.
