* @ValidationCode : Mjo1ODcyNzExNzE6Q3AxMjUyOjE1NjQ1NzIzNjQzNDU6c3JhdmlrdW1hcjotMTotMTowOi0xOmZhbHNlOk4vQTpERVZfMjAxOTA4LjA6LTE6LTE=
...
* Version 5 15/05/01  GLOBUS Release No. G13.0.00 05/07/02
*-----------------------------------------------------------------------------
* <Rating>678</Rating>
*-----------------------------------------------------------------------------
    $PACKAGE CQ.ChqPaymentStop
    SUBROUTINE CONV.PAYMENT.STOP.G13.1
*
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*
** 23/06/99 - GB9900864
**            Completed message left in program
*
* 29/05/04 - CI_10020222
*            Fatal error in load company
*            Select company only with the consolidation mark equal to
*            'NO'
*
...
*
                CALL BUILD.CHEQUES.STOPPED.G13.1
