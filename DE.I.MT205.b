* @ValidationCode : MjoxNzQ3NzYxMzA4OmNwMTI1MjoxNTU3OTE0MjY2Nzg3OmNtYW5pdmFubmFuOjE6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDE5MDUuMDo0MDI6MjMz
...
* @ValidationInfo : Coverage          : 233/402 (57.9%)
...
*   MODIFICATIONS                                                       *
*                                                                       *
* 26/09/02 - EN_10000786                                                *
*            New Program                                                *
*                                                                       *
* 04/10/02 - BG_100002189                                               *
...
*            Default credit ccy to debit ccy only if credit account is
*            not obtained.
*
...
* Check if the message is valid type and retrieve message format information
    ...
    R.DE.FORMAT.SWIFT = DE.Config.FormatSwift.Read('205.1.1', READ.ERROR)
...
* Initialise variables
    ...
    CRT "Starting DE.I.MT205 template program"
