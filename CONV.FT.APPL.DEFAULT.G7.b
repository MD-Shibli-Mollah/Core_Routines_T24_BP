...
*-----------------------------------------------------------------------------
    $PACKAGE FT.Config
    SUBROUTINE CONV.FT.APPL.DEFAULT.G7
*
...
*      YFILE = "F.CONV.FILE"             ;* File to be converted
    YFILE = "F.FT.APPL.DEFAULT"         ;* File to be converted
...
*      ADD.FIELD<2,1> = ""               ;* Number of fields to add.
    ADD.FIELD<1,1> = "19"     ;* Position to add from. (New field number)
...
*
    ...
    ETEXT ="FT.RTN.WHY.PROGRAM.ABORTED" ;* Used to update F.CONVERSION.PGMS
    CALL PGM.BREAK
*
*************************************************************************
END
