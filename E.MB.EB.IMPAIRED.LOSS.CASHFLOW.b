* @ValidationCode : MjozMzM5OTk0MjE6Y3AxMjUyOjE1ODMzOTM5NDI1MzU6a3JhbWFzaHJpOjI6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDMuMDoyMjY6MjI0
...
* @ValidationInfo : Coverage          : 224/226 (99.1%)
...
* checking the impairment loss details has amount.
        IF  IMPAIRMENT.LOSS NE "" THEN
            IF IMPAIRMENT.LOSS NE "0" OR LCY.IMPAIRMENT.LOSS NE "0" THEN
                Y.DATA<-1> = ARRAY
            END
        END
*-----------------------------------------------------------------------------------------
