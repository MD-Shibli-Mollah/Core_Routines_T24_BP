...
* Version 4 07/06/01  GLOBUS Release No. 200511 31/10/05
*-----------------------------------------------------------------------------
* <Rating>773</Rating>
*-----------------------------------------------------------------------------
    $PACKAGE SC.SctDealerBookPosition
      SUBROUTINE CONV.SC.TRADING.POSITION.G7007
*
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 52                ; * Position to add from. (New field number)
