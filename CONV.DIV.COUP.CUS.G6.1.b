...
*-----------------------------------------------------------------------------
    $PACKAGE SC.SccClassicCA
      SUBROUTINE CONV.DIV.COUP.CUS.G6.1
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.DIV.COUP.CUS"           ; * File to be converted
      COMPANY.CODE.POS = "64"            ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "41"              ; * Position to add from. (New field number)
