...
*
      ...
      COMPANY.CODE.POS = "88"            ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "74"              ; * Position to add from. (New field number)
...
*
      ...
      ETEXT ="LC.RTN.WHY.PROGRAM.ABORTED.2"        ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
