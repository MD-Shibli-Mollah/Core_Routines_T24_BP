* @ValidationCode : MjoxMDA1NjQ4NjMwOkNwMTI1MjoxNTY4NjA0NjIwNjAwOmNuaXZldGhhZGV2aTotMTotMTowOjE6ZmFsc2U6Ti9BOkRFVl8yMDE5MDkuMTotMTotMQ==
...
*-----------------------------------------------------------------------------
$PACKAGE DW.BiExport
SUBROUTINE DW.OL.SAMPLE.PRE.TRANSFORM.API(BI.FILE.NAME, rDwExportApi, T.BI.ID, rRecordImage, rProcessedValue)
...
*    rDwExportApi - DW Export API record for BI.FILE.NAME:TRANSFORM
...
*       Additional processing
        INCR += 1
        PROCESS.VALUES<-1> = 'PreTransform_Field_number_':INCR
    NEXT I
