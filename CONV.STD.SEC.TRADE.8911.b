...
*-----------------------------------------------------------------------------
    $PACKAGE SC.Config
      SUBROUTINE CONV.STD.SEC.TRADE.8911
*
...
*
            INS MISC.DB.CODE BEFORE R.SC.STD.SEC.TRADE<22>
            INS MISC.CR.CODE BEFORE R.SC.STD.SEC.TRADE<22>
            INS MISC.CATEGORY BEFORE R.SC.STD.SEC.TRADE<22>
            INS MISC.DB.CODE BEFORE R.SC.STD.SEC.TRADE<22>
            INS MISC.CR.CODE BEFORE R.SC.STD.SEC.TRADE<22>
            INS MISC.CATEGORY BEFORE R.SC.STD.SEC.TRADE<22>
*
...
************
      TEXT = E
      CALL FATAL.ERROR('CONV.SC.STD.SEC.TRADE.8911')
********
   END
