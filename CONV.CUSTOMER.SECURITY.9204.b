...
*-----------------------------------------------------------------------------
    $PACKAGE SC.Config
      SUBROUTINE CONV.CUSTOMER.SECURITY.9204
*
...
***!         IF NO.OF.FIELDS LT 31 THEN
         IF NOT(R.CUSTOMER.SECURITY<28> MATCHES "2A7N") AND NO.OF.FIELDS LT 31 THEN        ; * COMPANY CODE
            INS '' BEFORE R.CUSTOMER.SECURITY<14>  ; * SEC.ACC.DEF
            INS '' BEFORE R.CUSTOMER.SECURITY<14>  ; * SEC.ACC.DEF
            INS '' BEFORE R.CUSTOMER.SECURITY<14>  ; * SEC.ACC.DEF
         END
