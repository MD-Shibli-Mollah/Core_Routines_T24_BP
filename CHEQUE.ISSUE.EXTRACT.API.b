* @ValidationCode : MToxNjA3OTI3MzY5OklTTy04ODU5LTE6MTQ3NDUzNDc0NDg5NzpoYXJpcHJhc2F0aDoxOjA6LTU0Oi0xOmZhbHNlOk4vQTpERVZfMjAxNjA5LjE=
...
* @ValidationInfo : Copyright Temenos Headquarters SA 1993-2021. All rights reserved.
    ...
    $PACKAGE AA.Facility
    SUBROUTINE CHEQUE.ISSUE.EXTRACT.API(InFieldName,InOldRecord,InNewRecord,InApplicationId,OutAccountNumber,OutSystemId,OutAdditionalInfo,OutErrorFlag)
*-----------------------------------------------------------------------------
*
**** <region name= Program Description>
*** <desc>Purpose of the sub-routine</desc>
*
*** Its a extract API for the Inline TEC event type CHEQUE.ISSUE-SERVICE.
...
*			 Task : 1791958
*            API which is called from TEC Inline processing for the event type CHEQUE.ISSUE-SERVICE
*
*
*** </region>
*-----------------------------------------------------------------------------
...
*** Its not required for this application! Clear account field.No prefix/suffix are added!
    ...
    BEGIN CASE
        CASE InFieldName EQ "0" OR InFieldName EQ "@ID"   			;* Account number in @id
             OutAccountNumber = ""
        	 AA.Facility.TrimAccount("CHEQUE.ISSUE","@ID", InApplicationId, OutAccountNumber)
...
SetSystemId:
    ...
    OutSystemId = "CHQI"    ;* Should have an entry in EB.SYSTEM.ID
