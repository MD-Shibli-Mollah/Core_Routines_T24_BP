...
*-----------------------------------------------------------------------------
    $PACKAGE LC.Foundation
      SUBROUTINE CONV.LCBALANCES.14.2.0
*
...
*
      ...
      COMPANY.CODE.POS = "190"           ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ...
      TEXT = ""
      FILE.TYPE = 1                      ; * only change live file
      BEGIN CASE
         CASE FILE.TYPE EQ 1
            SUFFIX = ""
         CASE FILE.TYPE EQ 2
...
*
            ...
            REPEAT
*
            IF YREC<28> LT TODAY THEN
               YREC<117> = 0             ; * liab.amt
               YREC<118> = 0             ; * Liab.lccy
...
*
      ...
      ETEXT ="LC.RTN.WHY.PROGRAM.ABORTED.15"       ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
