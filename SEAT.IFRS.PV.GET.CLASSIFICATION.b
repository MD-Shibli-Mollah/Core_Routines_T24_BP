* @ValidationCode : Mjo0NjQ1MDE4Njk6Q3AxMjUyOjE1OTc2NTU5MTM3NzQ6dmhpbmR1amE6LTE6LTE6MDoxOmZhbHNlOk4vQTpERVZfMjAyMDA3LjIwMjAwNzAxLTA2NTc6LTE6LTE=
* @ValidationInfo : Timestamp         : 17 Aug 2020 14:48:33
...
$PACKAGE PV.Config
SUBROUTINE SEAT.IFRS.PV.GET.CLASSIFICATION(APP.NAME,CONT.ID,R.CONTRACT,RETURN.CLASS,CLASS.ERR)
*-----------------------------------------------------------------------------
...
*
* 9/04/20 - Enhancement 3580882 / Task 3580902
*            Allow Customers with Mnemonic as I9PV<XXXXXX> where XXXXXX is customer number
*            to return the contract's classification
*
* 22/7/2020 - Task 3849760
*            Allowing customers created for obligors also to be classified
*
* 17/8/2020 - Task 3915721
...
INITIALISE:
    ...
    BEGIN CASE
        ...
        CASE APP.NAME[1,2] EQ 'LI'
            CONTRACT.VAL.DATE = "20091223"
            CUSTOMER.KEY = R.CONTRACT<LI.Config.Limit.LiabilityNumber>   ;* Customer id
            GOSUB DETERMINE.GROUP.TYPE
            CATEGORY = R.CONTRACT<LI.Config.Limit.LimitProduct>
...
* LI.DETERMINE.LIABILITY.GROUP and get Liability Number from CUSTOMER.GROUP as returned by the API
    ...
    LIABILITY.NUMBER = ""
    ERROR.DETS = ""
    LI.Config.LiDetermineLiabilityGroupType(CONT.ID, R.CONTRACT, "GET.LIABILITY.CUSTOMER", "", "", GROUP.TYPE, LIABILITY.GROUP, LIABILITY.NUMBER, "", "", "", ERROR.DETS)
    IF GROUP.TYPE EQ "LIABILITY.GROUP" AND LIABILITY.GROUP THEN
        CUSTOMER.KEY = LIABILITY.NUMBER
    END
