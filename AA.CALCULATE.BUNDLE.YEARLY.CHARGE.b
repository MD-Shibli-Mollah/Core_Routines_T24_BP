* @ValidationCode : Mjo4MzIwMTYyNDA6Q3AxMjUyOjE1MjIxNTYwOTMxNzg6YXJvb3BhOjE6MDowOi0xOmZhbHNlOk4vQTpERVZfMjAxODA0LjIwMTgwMzEyLTAyMDA6MjcwOjE1OQ==
* @ValidationInfo : Timestamp         : 27 Mar 2018 18:38:13
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : aroopa
* @ValidationInfo : Nb tests success  : 1
* @ValidationInfo : Nb tests failure  : 0
* @ValidationInfo : Rating            : N/A
* @ValidationInfo : Coverage          : 159/270 (58.8%)
...
*----------------------------------------------------------------------------
$PACKAGE AA.Fees
SUBROUTINE AA.CALCULATE.BUNDLE.YEARLY.CHARGE(CHARGE.PROPERTY,R.PROPERTY.RECORD,BASE.AMOUNT,CHARGE.AMOUNT)
...
*            Task : 2447530
*            New local routine to calculate yearly charge amount for bundle based on tier details.
*
...
*** <desc> </desc>
    ...
    CHARGE.AMOUNT = CHARGE.AMOUNT*12 ;* to get yearly charge
...
** get the number of accounts in the pool and set it as the base amount
    ...
    TR.ACCOUNTS.COUNT = DCOUNT(ACCOUNT.LISTS<1>,@VM)
