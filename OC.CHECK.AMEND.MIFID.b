* @ValidationCode : Mjo5NzU4NTU5MTg6Q3AxMjUyOjE1OTk0NzYyMzE0MDg6a2JoYXJhdGhyYWo6NTowOjA6MTpmYWxzZTpOL0E6REVWXzIwMjAwOC4yMDIwMDczMS0xMTUxOjc0OjY0
* @ValidationInfo : Timestamp         : 07 Sep 2020 16:27:11
...
SUBROUTINE OC.CHECK.AMEND.MIFID(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
...
*The purpose of the routine is to check whether the user amend the deal in mifid report status only.
*Then it will produce OC.MIFID.DATA.
*Incoming parameters:
    ...
    BEGIN CASE
        CASE APPL.ID[1,2] EQ "ND"
            ...
            IF NdDealRec NE '' THEN
                ...
                IF (ActionType EQ NdDealRec<FX.Contract.NdDeal.NdDealActionType>) AND (MifidReportStatus NE NdDealRec<FX.Contract.NdDeal.NdDealMifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
        ...
        CASE APPL.ID[1,2] EQ "SW"
            ...
            IF SwDealRec NE '' THEN
                ...
                IF (ActionType EQ SwDealRec<SW.Contract.Swap.ActionType>) AND (MifidReportStatus NE SwDealRec<SW.Contract.Swap.MifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
        ...
        CASE APPL.ID[1,2] EQ "FR"
            ...
            IF FrDealRec NE '' THEN
                ...
                IF (ActionType EQ FrDealRec<FR.Contract.FraDeal.FrdActionType>) AND (MifidReportStatus NE FrDealRec<FR.Contract.FraDeal.FrdMifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
        ...
        CASE APPL.ID[1,2] EQ "DX"
            ...
            IF DxDealRec NE '' THEN
                ...
                IF (ActionType EQ DxDealRec<DX.Trade.Trade.TraActionType>) AND (MifidReportStatus NE DxDealRec<DX.Trade.Trade.TraMifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
        ...
        CASE APPL.ID[1,2] EQ "FX"
            ...
            IF FxDealRec NE '' THEN
                ...
                IF (ActionType EQ FxDealRec<FX.Contract.Forex.ActionType>) AND (MifidReportStatus NE FxDealRec<FX.Contract.Forex.MifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
