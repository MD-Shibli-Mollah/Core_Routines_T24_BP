...
*
    ...
    NEXT X
    CLS := @(0,4)
    YFILE = "F.FX.PARAMETERS" ;* File to be converted
    COMPANY.CODE.POS = "37"   ;* Position of new XX.CO.CODE in the file
    F.PGM.FILE = ''
...
** file is being converted more than once.
    CANCEL.FIELD = ""
*
** Add the position where new fields start, plus the number of fields required.
...
** file is being converted more than once.
    ...
    ADD.FIELD<2,1> = "8"      ;* Number of fields to add.
*
*************************************************************************
*
...
*
    ...
    ETEXT ="FX.RTN.WHY.PROGRAM.ABORTED.3"         ;* Used to update F.CONVERSION.PGMS
    CALL PGM.BREAK
*
*************************************************************************
END
