* @ValidationCode : MjotNDM4NTA2MTM4OkNwMTI1MjoxNTk5NjQ1MDc2ODE1OmtiaGFyYXRocmFqOjU6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDguMjAyMDA3MzEtMTE1MTo1NTo1NQ==
...
SUBROUTINE OC.UPD.SELL.COUNTRY(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
*-----------------------------------------------------------------------------
*<Routine description>
*
* Populate the value only when MIFID.REPORT.STATUS as "NEWT".
* Attached as a link routine in TX.TXN.BASE.MAPPING record to
* If NATIONAL.ID is populated in field SELLER.ID then fetch COUNTRY from CUSTOMER table for the counterparty
* Incoming parameters:
*
