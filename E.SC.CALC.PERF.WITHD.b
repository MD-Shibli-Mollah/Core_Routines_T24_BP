* @ValidationCode : MjozMjIxMTQ4ODE6Q3AxMjUyOjE0ODU5NDEwODE3MjU6ZHBvb3JuaW1hOjI6MDowOi0xOmZhbHNlOk4vQTpERVZfMjAxNzAxLjA6NTE6NTE=
...
*-----------------------------------------------------------------------------
    ...
    SUBROUTINE E.SC.CALC.PERF.WITHD
************************************************************
*
...
*
    ...
    IF CCY1 NE CCY2 AND WITHDRAWALS THEN
        VAL1 = WITHDRAWALS
        VAL2 = ''
        RET.CODE = ''
        RATE = ''
        ...
        END
    END  ELSE
        EB.Reports.setOData(WITHDRAWALS)
    END
*
    RETURN
    END
