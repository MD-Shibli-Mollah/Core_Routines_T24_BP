...
*
    $PACKAGE DX.Position
      SUBROUTINE CONV.DX.RP.ACT.HIST.R08(DX.REP.POS.ACT.HIST.ID,R.DX.REP.POS.ACT.HIST,FN.DX.REP.POS.ACT.HIST)
*-----------------------------------------------------------------------------
...
*
* Conversion of DX.REP.POS.ACT.HIST
*
...
* Change the data in the fields
      ...
      eventCodeList = R.DX.REP.POS.ACT.HIST<eventFldPos>
      ...
      FOR eventCodeNo = 1 TO eventCodeCount
         ...
         R.DX.REP.POS.ACT.HIST<eventFldPos,eventCodeNo> = eventCode
      NEXT eventCodeNo
