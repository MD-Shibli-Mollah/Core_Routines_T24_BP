...
*
    $PACKAGE DX.Position
      SUBROUTINE CONV.DX.REP.POS.ACT.R08(DX.REP.POS.ACTIVITY.ID,R.DX.REP.POS.ACTIVITY,FN.DX.REP.POS.ACTIVITY)
*-----------------------------------------------------------------------------
...
*
* Conversion of DX.REP.POS.ACTIVITY
*
...
* Change data for field
      ...
      eventCodeList = R.DX.REP.POS.ACTIVITY<eventFldPos>
      ...
      FOR eventCodeNo = 1 TO eventCodeCount
         ...
         R.DX.REP.POS.ACTIVITY<eventFldPos,eventCodeNo> = eventCode
      NEXT eventCodeNo
