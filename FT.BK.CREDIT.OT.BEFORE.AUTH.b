...
*
    ...
    SUBROUTINE FT.BK.CREDIT.OT.BEFORE.AUTH
*-----------------------------------------------------------------------
...
*-----------------------------------------------------------------------
    ...
    FOR VM.POS = 1 TO VM.CNT
        ...
        tmp=EB.SystemTables.getRNew(FT.BulkProcessing.BulkCrOt.BkcrotOfsGenId); tmp<1,CURR.MV.NO>=OUT.DATA<2, VM.POS>; EB.SystemTables.setRNew(FT.BulkProcessing.BulkCrOt.BkcrotOfsGenId, tmp);* Store the TXN ids
        tmp=EB.SystemTables.getRNew(FT.BulkProcessing.BulkCrOt.BkcrotOfsErrYN); tmp<1,CURR.MV.NO>=OUT.DATA<3, VM.POS>; EB.SystemTables.setRNew(FT.BulkProcessing.BulkCrOt.BkcrotOfsErrYN, tmp);* Indicate the TXNs with error
    NEXT VM.POS
