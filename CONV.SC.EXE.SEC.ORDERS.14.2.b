...
*-----------------------------------------------------------------------------
    $PACKAGE SC.SctOrderExecution
      SUBROUTINE CONV.SC.EXE.SEC.ORDERS.14.2
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.SC.EXE.SEC.ORDERS"      ; * File to be converted
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 29                ; * Position to add from. (New field number)
