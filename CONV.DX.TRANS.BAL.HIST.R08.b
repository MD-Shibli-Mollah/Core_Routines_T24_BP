...
*
    $PACKAGE DX.Accounting
      SUBROUTINE CONV.DX.TRANS.BAL.HIST.R08(DX.TRANS.BALANCES.HIST.ID,R.DX.TRANS.BALANCES.HIST,FN.DX.TRANS.BALANCES.HIST)
*-----------------------------------------------------------------------------
...
*
* Conversion of DX.TRANS.BALANCES.HIST
*
...
* Change the data in the field
      ...
      eventCodeList = R.DX.TRANS.BALANCES.HIST<eventFldPos>
      ...
      FOR eventCodeNo = 1 TO eventCodeCount
         ...
         R.DX.TRANS.BALANCES.HIST<eventFldPos,eventCodeNo> = eventCode
      NEXT eventCodeNo
