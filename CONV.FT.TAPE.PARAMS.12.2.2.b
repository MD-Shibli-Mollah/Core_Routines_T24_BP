...
*-----------------------------------------------------------------------------
    $PACKAGE FT.Clearing
      SUBROUTINE CONV.FT.TAPE.PARAMS.12.2.2
*
** Where REL.NO is the major release number and not the dot release
** eg 12.1 but not 12.1.2
** Note this should ONLY be run if updagrading from 12.2.1 to 12.2.2
*
$INSERT I_COMMON
$INSERT I_EQUATE
$INSERT I_F.COMPANY
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 11                ; * Position to add from. (New field number)
