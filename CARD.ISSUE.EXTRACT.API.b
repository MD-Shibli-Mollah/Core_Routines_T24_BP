* @ValidationCode : MToxMjUwMjQ4MDA2OklTTy04ODU5LTE6MTQ3NDUzNDc0NDg4NzpoYXJpcHJhc2F0aDoxOjA6LTUzOi0xOmZhbHNlOk4vQTpERVZfMjAxNjA5LjE=
...
*-----------------------------------------------------------------------------
    $PACKAGE AA.Facility
    SUBROUTINE CARD.ISSUE.EXTRACT.API(InFieldName,InOldRecord,InNewRecord,InApplicationId,OutAccountNumber,OutSystemId,OutAdditionalInfo,OutErrorFlag)
*-----------------------------------------------------------------------------
*
**** <region name= Program Description>
*** <desc>Purpose of the sub-routine</desc>
*
*** Its a extract API for the Inline TEC event type CARD.ISSUE-SERVICE.
...
*			 Task : 1791958
*            API which is called from TEC Inline processing for the event type CARD.ISSUE-SERVICE
*
*** </region>
*-----------------------------------------------------------------------------
...
*** Its not required for this application! Clear account field.No prefix/suffix are added!
    ...
    BEGIN CASE
        CASE InFieldName EQ "0" OR InFieldName EQ "@ID"   			;* Account number in @id
             OutAccountNumber = ""
        	 AA.Facility.TrimAccount("CARD.ISSUE","@ID", InApplicationId, OutAccountNumber)
...
SetSystemId:
    ...
    OutSystemId = "CRDI"    ;* Should have an entry in EB.SYSTEM.ID
