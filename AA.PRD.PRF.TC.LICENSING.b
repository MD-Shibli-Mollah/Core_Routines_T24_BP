* @ValidationCode : MjoyMzMwMDIxODk6Q3AxMjUyOjE1NzE3MzczODkzOTU6c3VkaGFyYW1lc2g6LTE6LTE6MDoxOmZhbHNlOk4vQTpERVZfMjAxOTEwLjIwMTkwOTIwLTA3MDc6LTE6LTE=
...
SUBROUTINE AA.PRD.PRF.TC.LICENSING
*-----------------------------------------------------------------------------
* Properties and Methods for AA.PRD.PRF.TC.LICENSING
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
    tmp=EB.Template.getCProperties(); tmp<EB.Template.PTitle>='AA Product Proof -TC Licensing'; EB.Template.setCProperties(tmp);* Screen title
...
*
    ...
    EB.SystemTables.setApplication('AA.PRD.PRF.TC.LICENSING')
*
