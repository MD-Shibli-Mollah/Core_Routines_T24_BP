* @ValidationCode : MjozODE4MTQ1MTQ6Q3AxMjUyOjE1NzE3MzczODkxNTU6c3VkaGFyYW1lc2g6LTE6LTE6MDoxOmZhbHNlOk4vQTpERVZfMjAxOTEwLjIwMTkwOTIwLTA3MDc6LTE6LTE=
...
SUBROUTINE AA.PRD.CAT.TC.LICENSING
*-----------------------------------------------------------------------------
* Properties and Methods for AA.PRD.CAT.TC.LICENSING
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
    tmp=EB.Template.getCProperties(); tmp<EB.Template.PTitle>='AA Product Catalogue -TC Licensing'; EB.Template.setCProperties(tmp);* Screen title
...
*
    ...
    EB.SystemTables.setApplication('AA.PRD.CAT.TC.LICENSING')
*
