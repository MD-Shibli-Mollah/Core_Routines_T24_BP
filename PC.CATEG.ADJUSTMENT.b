...
* Version 3 02/06/00  GLOBUS Release No. 200508 30/06/05
    ...
    $PACKAGE PC.Contract
    SUBROUTINE PC.CATEG.ADJUSTMENT
...
*************************************************************************
    ...
    EB.SystemTables.setIdF('PC.CATEG.ID'); EB.SystemTables.setIdN('60'); tmp=EB.SystemTables.getIdT(); tmp<1>='A'; EB.SystemTables.setIdT(tmp)

    Z += 1 ; EB.SystemTables.setF(Z, 'CATEG.ENTRY.ID'); EB.SystemTables.setN(Z, '35'); tmp=EB.SystemTables.getT(Z); tmp<1>='A'; EB.SystemTables.setT(Z, tmp)
    ...
    EB.SystemTables.setV(Z + 9); EB.SystemTables.setPrefix('PCC')
