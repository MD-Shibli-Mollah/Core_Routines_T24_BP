...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.DRAWINGS"               ; * File to be converted
      COMPANY.CODE.POS = "98"            ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
** file is being converted more than once.
      ...
      ADD.FIELD<1,2> = "22"              ; * Position to add from. (New field number)
      ADD.FIELD<2,2> = "1"               ; * Number of fields to add.

      ADD.FIELD<1,3> = "33"              ; * Position to add from. (New field number)
      ADD.FIELD<2,3> = "3"               ; * Number of fields to add.
*
      ADD.FIELD<1,4> = "82"              ; * Position to add from. (New field number)
      ADD.FIELD<2,4> = "5"               ; * Number of fields to add.
*************************************************************************
*
...
*
      ...
      ETEXT ="LC.RTN.WHY.PROGRAM.ABORTED"          ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
