...
*-----------------------------------------------------------------------------
    $PACKAGE EB.Repgens
      SUBROUTINE CONV.REPGEN.CREATE.14.1
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.REPGEN.CREATE"          ; * File to be converted
      COMPANY.CODE.POS = 99              ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 89                ; * Position to add from. (New field number)
