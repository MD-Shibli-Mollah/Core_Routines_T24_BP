...
*-----------------------------------------------------------------------------
    $PACKAGE SC.SctOrderCapture
      SUBROUTINE CONV.SEC.OPEN.ORDER.14.2
*
...
*
* 07/08/95 GB9500910
*          Only add one field at field number 23 (currently adding 2
*          fields)
*
*************************************************************************
INITIALISE:
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "38"              ; * Position to add from. (New field number)
      ...
      ADD.FIELD<1,3> = "1"               ; * Position to add from. (New field number)
