* @ValidationCode : MjotMTk5OTgyNTYzMjpDcDEyNTI6MTU5OTQ3NjkwNDk3NzprYmhhcmF0aHJhajo1OjA6MDoxOmZhbHNlOk4vQTpERVZfMjAyMDA4LjIwMjAwNzMxLTExNTE6NTQ6NTQ=
* @ValidationInfo : Timestamp         : 07 Sep 2020 16:38:24
...
SUBROUTINE OC.UPD.BUY.DEC.MKR.NAME1(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
*-----------------------------------------------------------------------------
*<Routine description>
*
* Populate the value only when MIFID.REPORT.STATUS as "NEWT".
* Attached as a link routine in TX.TXN.BASE.MAPPING record to
* If NATIONAL.ID is populated in field BUYER.DECISION.MKR then fetch NAME.1 from CUSTOMER table for the DecisionMkrId.
* Incoming parameters:
*
