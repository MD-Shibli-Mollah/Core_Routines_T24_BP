* @ValidationCode : MjoxOTQ3NTI5MjpDcDEyNTI6MTYxMDM5NzcyMjAxNjpyZGVlcGlnYTo2OjA6MDoxOmZhbHNlOk4vQTpERVZfMjAyMDEyLjIwMjAxMTI4LTA2MzA6NDQ6NDQ=
...
SUBROUTINE SCDX.TRS.UPD.SELL.DEC.MKR.NAME1(TXN.ID,TXN.REC,TXN.DATA,RET.VAL)
*-----------------------------------------------------------------------------
...
* Outgoing parameters:
**********************
* RET.VAL  -  If Customer is Seller, then RET.VAL will be First Name of Decision Maker
*
*-----------------------------------------------------------------------------
...
* Check if the customer is buyer or seller
    ...
    BEGIN CASE
* Security Txn:
* If the customer mentioned in CUSTOMER.NO is Seller, then first name of the customer defined in the field DECISION.MKR.ID will be returned
...
* Derivative Txn:
* If PRI.CUST.TYPE is Customer and PRI.BUY.SELL is SELL, then shall populate this field with the first name of the customer defined in the field DECISION.MKR.ID.
* If SEC.CUST.TYPE is Customer and SEC.BUY.SELL is SELL, then shall populate this field with the first name of the customer defined in the field DECISION.MKR.ID.
    ...
    GOSUB GET.CUS.NAME1 ; *Get the First Name for the Customer *
*
RETURN
*** </region>
*-----------------------------------------------------------------------------
...
*** </region>
*-----------------------------------------------------------------------------
*** <region name= GET.CUS.NAME1>
GET.CUS.NAME1:
*** <desc>Get the First Name for the Customer </desc>
