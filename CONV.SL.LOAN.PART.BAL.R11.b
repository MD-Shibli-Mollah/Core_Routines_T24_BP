...
*-----------------------------------------------------------------------------
    $PACKAGE SL.Contract
    SUBROUTINE CONV.SL.LOAN.PART.BAL.R11(LN.ID, LN.REC, SLL.FILE)
...
*** <desc>Inserts </desc>
    ...
    $INSERT I_COMMON
    $INSERT I_EQUATE
    EQU SLP.RATE.EFF.DT TO 20
    EQU SLP.INT.BASIS TO 19
...
*** <desc>Initialise </desc>
    ...
    LOAN.ERR1 = ''
    LOAN.ERR2 = ''
    CALL F.READ(FN.SL.LOANS,LN.ID[1,19],SL.LOANS.REC,FV.SL.LOANS,LOAN.ERR1)
    IF NOT(SL.LOANS.REC) THEN
        FN.SL.LOANS$NAU = 'F.SL.LOANS$NAU'
        FV.SL.LOANS$NAU = ''
        CALL F.READ(FN.SL.LOANS$NAU,LN.ID[1,19],SL.LOANS.REC,FV.SL.LOANS$NAU,LOAN.ERR2)
    END
...
*** <desc>Main Program </desc>
    ...
    FOR I = 1 TO EFF.DATE.CNT
        LN.REC<SLP.INT.BASIS,I> = SL.LOANS.REC<SL.LN.INTEREST.BASIS>
    NEXT I
