* @ValidationCode : MTozMjc2MTc1ODU6SVNPLTg4NTktMToxNDc0NTM0NzQ0ODAyOmhhcmlwcmFzYXRoOjE6MDotNTM6LTE6ZmFsc2U6Ti9BOkRFVl8yMDE2MDkuMQ==
...
*-----------------------------------------------------------------------------
    $PACKAGE AA.Facility
    SUBROUTINE DD.DDI.EXTRACT.API(InFieldName,InOldRecord,InNewRecord,InApplicationId,OutAccountNumber,OutSystemId,OutAdditionalInfo,OutErrorFlag)
*-----------------------------------------------------------------------------
*
**** <region name= Program Description>
*** <desc>Purpose of the sub-routine</desc>
*
*** Its a extract API for the Inline TEC event type DD.DDI-SERVICE.
...
*			 Task : 1791958
*            API which is called from TEC Inline processing for the event type DD.DDI-SERVICE
*
*
*** </region>
*-----------------------------------------------------------------------------
...
*** Its not required for this application! Clear account field.No prefix/suffix are added!
    ...
    BEGIN CASE
        CASE InFieldName EQ "0" OR InFieldName EQ "@ID"   			;* Account number in @id
             OutAccountNumber = ""
        	 AA.Facility.TrimAccount("DD.DDI","@ID", InApplicationId, OutAccountNumber)
        CASE InFieldName EQ "ACCT.FOR.INT.REQ"								;* Application fields
        CASE 1														;* Local fields!
    END CASE
...
SetSystemId:
    ...
    OutSystemId = "DDI"    ;* Should have an entry in EB.SYSTEM.ID
