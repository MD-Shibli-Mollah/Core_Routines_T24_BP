* @ValidationCode : Mjo0MTIyMDkxNDg6Q3AxMjUyOjE1NzE3MzczODc2MTE6c3VkaGFyYW1lc2g6LTE6LTE6MDoxOmZhbHNlOk4vQTpERVZfMjAxOTEwLjIwMTkwOTIwLTA3MDc6LTE6LTE=
...
* @ValidationInfo : Copyright Temenos Headquarters SA 1993-2021. All rights reserved.
    ...
    SUBROUTINE AA.PRD.CAT.TC.AVAILABILITY
*-----------------------------------------------------------------------------
* Properties and Methods for AA.PRD.CAT.TC.AVAILABILITY
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
    tmp=EB.Template.getCProperties(); tmp<EB.Template.PTitle>='AA Product Catalogue - Connect Availability'; EB.Template.setCProperties(tmp);* Screen title
...
*
    ...
    EB.SystemTables.setApplication('AA.PRD.CAT.TC.AVAILABILITY')
*
