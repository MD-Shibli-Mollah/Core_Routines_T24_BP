* @ValidationCode : MjotNTc3NTk0NTU0OkNwMTI1MjoxNTk5NjQ1MDk0NzU0OmtiaGFyYXRocmFqOjU6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDguMjAyMDA3MzEtMTE1MTo1NDo1NA==
* @ValidationInfo : Timestamp         : 09 Sep 2020 15:21:34
...
SUBROUTINE OC.UPD.SELL.DEC.MKR.DOB(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
*-----------------------------------------------------------------------------
*<Routine description>
*
* Populate the value only when MIFID.REPORT.STATUS as "NEWT".
* Attached as a link routine in TX.TXN.BASE.MAPPING record to
* If NATIONAL.ID is populated in field SELLER.DECISION.MKR then fetch BIRTH.INCORP.DATE from CUSTOMER table for the DecisionMkrId
* Incoming parameters:
*
