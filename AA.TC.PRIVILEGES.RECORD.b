* @ValidationCode : MjotMTE5Mjg1MzEzMDpDcDEyNTI6MTU3MTczNzc3Nzc0NzpzdWRoYXJhbWVzaDozOjA6MDoxOmZhbHNlOk4vQTpERVZfMjAxOTEwLjIwMTkwOTIwLTA3MDc6MzI6MzI=
...
* @ValidationInfo : Copyright Temenos Headquarters SA 1993-2021. All rights reserved.
    ...
    SUBROUTINE AA.TC.PRIVILEGES.RECORD(RET.ERROR)
*--------------------------------------------------------------------------------------------------------------
* Description :
...
** Make Defined Product Groups as NOINPUT fields. So user is not allowed to amend.
    tmp=EB.SystemTables.getT(AO.Framework.TcPrivileges.AaTcPrivService)
    tmp<3>="NOINPUT"
    EB.SystemTables.setT(AO.Framework.TcPrivileges.AaTcPrivService, tmp)
    tmp=EB.SystemTables.getT(AO.Framework.TcPrivileges.AaTcPrivOperation)     ;* Defined product groups field is made NOINPUT
    tmp<3>="NOINPUT"
    EB.SystemTables.setT(AO.Framework.TcPrivileges.AaTcPrivOperation, tmp)
*
    RETURN
*** </region>
************************************************************************************
