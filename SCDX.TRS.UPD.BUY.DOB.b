* @ValidationCode : MjotMjI0MTk4MDU1OkNwMTI1MjoxNjA0ODM3NDk5MDU3OnJkZWVwaWdhOjQ6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDkuMjAyMDA4MjgtMTYxNzoyOToyOQ==
...
SUBROUTINE SCDX.TRS.UPD.BUY.DOB(TXN.ID,TXN.REC,TXN.DATA,RET.VAL)
*-----------------------------------------------------------------------------
* This routine returns the Date of Birth of customer if the customer is of Buy side
...
* Outgoing parameters:
**********************
* RET.VAL  -  If Customer is Buyer, then RET.VAL will hold the date of Birth of customer
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
    ...
    GOSUB PROCESS       ; *Process to return the Date of Birth of customer if Customer is Buyer
...
*** <region name= PROCESS>
PROCESS:
*** <desc>Process to return the Date of Birth of customer if Customer is Buyer for reporting purpose </desc>
...
* Check if the customer is buyer or seller
    ...
    BEGIN CASE
* Security Txn:
* If the customer mentioned in CUSTOMER.NO is Buyer, then date of birth of that customer will be populated
...
* Derivative Txn:
* If the field PRI.BUY.SELL is set as Buy, then date of Birth of the customer specified in the field PRI.CUST.NO shall be populated
