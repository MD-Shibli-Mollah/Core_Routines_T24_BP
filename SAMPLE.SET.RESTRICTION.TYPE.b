...
* @ValidationInfo : Copyright Temenos Headquarters SA 1993-2021. All rights reserved.
    ...
    SUBROUTINE SAMPLE.SET.RESTRICTION.TYPE(iInputHook, oRestrictionDetails, oHookError)
*-----------------------------------------------------------------------------
...
*
    ...
    $INSERT I_AccountandCustomerInterfaceService_InputHook
    $INSERT I_AccountandCustomerInterfaceService_RestrictionDetails
    $INSERT I_DebitPartyDeterminationService_DASError
*
*-----------------------------------------------------------------------------
* Process
*
    CALL TPSLogging("Start","SAMPLE HOOK AC","","")
    
    CALL TPSLogging("Input Parameter","SAMPLE HOOK AC","iInputHook: <":iInputHook:">","")
    ...
    CALL TPSLogging("Output Parameter","SAMPLE HOOK AC","oRestrictionDetails: <":oRestrictionDetails:">","")

    CALL TPSLogging("Output Parameter","SAMPLE HOOK AC","oHookError: <":oHookError:">","")
...
*** <desc>Assign all the output parameter </desc>
    oRestrictionDetails<RestrictionDetails.creditRestrictType> = creditRestrictType
    oRestrictionDetails<RestrictionDetails.debitRestrictType> = debitRestrictType
    oRestrictionDetails<RestrictionDetails.creditRestrictDesc> = creditRestrictDesc
    oRestrictionDetails<RestrictionDetails.debitRestrictDesc> = debitRestrictDesc
    RETURN
*** </region>
