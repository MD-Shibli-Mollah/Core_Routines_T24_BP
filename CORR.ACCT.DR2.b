...
* Version 15 21/06/01  GLOBUS Release No. G12.0.00 29/06/01
*-----------------------------------------------------------------------------
* <Rating>918</Rating>
*-----------------------------------------------------------------------------
    $PACKAGE IC.InterestAndCapitalisation
    SUBROUTINE CORR.ACCT.DR2
REM "CORR.ACCT.DR2",850725-001,"MAINPGM"
*
* GB9400210- 09-05-94
...
*************************************************************************
REM "DEFINE PGM NAME (BY USING 'C/CORR.ACCT.DR2/.../G9999')
*========================================================================
...
* checkfile "ACCOUNT":FM:AC.CUSTOMER:FM:FM:"CUSTOMER":FM:EB.CUS.SHORT.NAME separately
    ...
    IC.InterestAndCapitalisation.StmtAcctDrTwoFields()

    EB.SystemTables.setPrefix("IC.CORD2")
*========================================================================
...
* assigned customer's short name to ID.ENRI varible to get enrichment to id.
    ...
    tmp=EB.SystemTables.getT(20); tmp<2,2>=YCCY; EB.SystemTables.setT(20, tmp); tmp=EB.SystemTables.getT(21); tmp<2,2>=YCCY; EB.SystemTables.setT(21, tmp); tmp=EB.SystemTables.getT(22); tmp<2,2>=YCCY; EB.SystemTables.setT(22, tmp)
