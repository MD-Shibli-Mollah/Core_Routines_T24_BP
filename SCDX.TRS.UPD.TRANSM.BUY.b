* @ValidationCode : MjoxMzA3NzA0NDIyOkNwMTI1MjoxNjA0ODM3NTAyMDQxOnJkZWVwaWdhOjI6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDkuMjAyMDA4MjgtMTYxNzoyMDoyMA==
...
SUBROUTINE SCDX.TRS.UPD.TRANSM.BUY(TXN.ID,TXN.REC,TXN.DATA,RET.VAL)
*-----------------------------------------------------------------------------
* This routine returns the LEI of the Broker only for Buy/Purchase
...
* Outgoing parameters:
**********************
* RET.VAL  -  LEI of the Broker if the Customer is Buyer
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
    ...
    IF CUS.SIDE EQ 'B' THEN
        GOSUB PROCESS       ; *Process to return the LEI of the Broker for Purchase transaction
    END
*
RETURN
*-----------------------------------------------------------------------------
