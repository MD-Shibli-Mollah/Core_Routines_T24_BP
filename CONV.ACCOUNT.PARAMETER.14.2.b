...
* Version 3 18/05/01  GLOBUS Release No. 200511 31/10/05
*-----------------------------------------------------------------------------
* <Rating>531</Rating>
*-----------------------------------------------------------------------------
    $PACKAGE AC.Config
      SUBROUTINE CONV.ACCOUNT.PARAMETER.14.2
*
...
*
      ...
      COMPANY.CODE.POS = 27              ; * Position of XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 15                ; * Position to add from.
