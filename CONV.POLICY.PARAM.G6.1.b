...
*-----------------------------------------------------------------------------
    $PACKAGE SC.SctModelling
      SUBROUTINE CONV.POLICY.PARAM.G6.1
*
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "12"              ; * Position to add from. (New field number)
      ...
      ADD.FIELD<1,3> = "6"               ; * Position to add from. (New field number)
      ADD.FIELD<2,3> = "2"               ; * Number of fields to add.
      ADD.FIELD<1,4> = "5"               ; * Position to add from. (New field number)
      ADD.FIELD<2,4> = "1"               ; * Number of fields to add.
      ADD.FIELD<1,5> = "2"               ; * Position to add from. (New field number)
      ADD.FIELD<2,5> = "2"               ; * Number of fields to add.
      ADD.FIELD<1,6> = "1"               ; * Position to add from. (New field number)
      ADD.FIELD<2,6> = "2"               ; * Number of fields to add.
*
*************************************************************************
*
