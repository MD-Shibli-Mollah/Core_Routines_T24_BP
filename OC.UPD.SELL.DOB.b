* @ValidationCode : MjoxMDQ5ODYzMjQ5OkNwMTI1MjoxNTk5NjQ1MDc2OTk3OmtiaGFyYXRocmFqOjU6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDguMjAyMDA3MzEtMTE1MTo1NTo1NQ==
* @ValidationInfo : Timestamp         : 09 Sep 2020 15:21:16
...
SUBROUTINE OC.UPD.SELL.DOB(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
*-----------------------------------------------------------------------------
*<Routine description>
*
* Populate the value only when MIFID.REPORT.STATUS as "NEWT".
* Attached as a link routine in TX.TXN.BASE.MAPPING record to
* If NATIONAL.ID is populated in field SELLER.ID then fetch BIRTH.INCORP.DATE from CUSTOMER table for the counterparty
* Incoming parameters:
*
