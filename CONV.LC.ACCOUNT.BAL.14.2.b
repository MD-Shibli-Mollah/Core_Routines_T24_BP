...
*-----------------------------------------------------------------------------
    $PACKAGE LC.Foundation
      SUBROUTINE CONV.LC.ACCOUNT.BAL.14.2
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = 'F.LC.ACCOUNT.BALANCES'
      COMPANY.CODE.POS = "69"            ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
** file is being converted more than once.
      ...
      ADD.FIELD<2,1> = "29"              ; * Number of fields to add.
*
*************************************************************************
*
...
*
      ...
      ETEXT ="LC.RTN.WHY.PROGRAM.ABORTED.6"        ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
