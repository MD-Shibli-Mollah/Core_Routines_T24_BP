...
*
    $PACKAGE DX.Revaluation
      SUBROUTINE CONV.DX.REVAL.TXN.HIST.R08(DX.REVAL.TXN.HIST.ID,R.DX.REVAL.TXN.HIST,FN.DX.REVAL.TXN.HIST)
*-----------------------------------------------------------------------------
...
*
* Conversion of DX.REVAL.TXN.HIST
*
...
* Change data for field EVENT.TYPE
      ...
      eventCodeList = R.DX.REVAL.TXN.HIST<eventFldPos>
      ...
      FOR eventCodeNo = 1 TO eventCodeCount
         ...
         R.DX.REVAL.TXN.HIST<eventFldPos,eventCodeNo> = eventCode
      NEXT eventCodeNo

* Change data for field ACT.EVENT.TYPE

      eventCodeList = R.DX.REVAL.TXN.HIST<eventFldPosTwo>
      eventCodeCount = DCOUNT(eventCodeList,VM)

      FOR eventCodeNo = 1 TO eventCodeCount
         eventCode = eventCodeList<1,eventCodeNo>
         GOSUB MODIFY.EVENT.CODE
         R.DX.REVAL.TXN.HIST<eventFldPosTwo,eventCodeNo> = eventCode
      NEXT eventCodeNo
