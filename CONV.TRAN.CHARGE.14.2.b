...
*-----------------------------------------------------------------------------
    $PACKAGE IC.InterestAndCapitalisation
      SUBROUTINE CONV.TRAN.CHARGE.14.2
*
*
$INSERT I_COMMON
$INSERT I_EQUATE
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.TRANSACTION.CHARGE"     ; * File to be converted
      COMPANY.CODE.POS = "22"            ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ...
      ETEXT ="IC.RTN.WHY.PROGRAM.ABORTED"          ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
