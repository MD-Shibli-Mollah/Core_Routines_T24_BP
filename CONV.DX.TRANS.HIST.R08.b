...
*
    $PACKAGE DX.Trade
      SUBROUTINE CONV.DX.TRANS.HIST.R08(DX.TRANSACTION.HISTORY.ID,R.DX.TRANSACTION.HISTORY,FN.DX.TRANSACTION.HISTORY)
*-----------------------------------------------------------------------------
...
*
* Conversion of DX.TRANSACTION.HISTORY
*
...
* Change data for fields

* Change data for field EVENT.TYPE

      eventCodeList = R.DX.TRANSACTION.HISTORY<eventFldPos>
      ...
      FOR eventCodeNo = 1 TO eventCodeCount
         ...
         R.DX.TRANSACTION.HISTORY<eventFldPos,eventCodeNo> = eventCode
      NEXT eventCodeNo

* Change data for ACT.EVENT.TYPE

      eventCodeList = R.DX.TRANSACTION.HISTORY<eventFldPosTwo>
      eventCodeCount = DCOUNT(eventCodeList,VM)

      FOR eventCodeNo = 1 TO eventCodeCount
         eventCode = eventCodeList<1,eventCodeNo>
         GOSUB MODIFY.EVENT.CODE
         R.DX.TRANSACTION.HISTORY<eventFldPosTwo,eventCodeNo> = eventCode
      NEXT eventCodeNo
