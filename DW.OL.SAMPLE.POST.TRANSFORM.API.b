* @ValidationCode : MjoyMDA3Mzk3MjE4OkNwMTI1MjoxNTY4NjA0NjIwNTgyOmNuaXZldGhhZGV2aTotMTotMTowOjE6ZmFsc2U6Ti9BOkRFVl8yMDE5MDkuMTotMTotMQ==
...
*-----------------------------------------------------------------------------
$PACKAGE DW.BiExport
SUBROUTINE DW.OL.SAMPLE.POST.TRANSFORM.API(BI.FILE.NAME, rDwExportApi, T.BI.ID, rRecordImage, rProcessedValue)
...
*       Additional processing
        INCR += 1
        PROCESS.VALUES<-1> = 'PostTransform_Field_number_':INCR
    NEXT I
