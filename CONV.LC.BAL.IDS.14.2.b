...
*-----------------------------------------------------------------------------
    $PACKAGE LC.Foundation
      SUBROUTINE CONV.LC.BAL.IDS.14.2
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.LC.ACCOUNT.BALANCES"    ; * File to be converted
      COMPANY.CODE.POS = "999"           ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ...
      ETEXT ="LC.RTN.WHY.PROGRAM.ABORTED.7"        ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
