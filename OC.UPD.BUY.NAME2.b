* @ValidationCode : MjotMTY2MTU0MDA3MzpDcDEyNTI6MTU5OTQ3NjIzODQyOTprYmhhcmF0aHJhajo1OjA6MDoxOmZhbHNlOk4vQTpERVZfMjAyMDA4LjIwMjAwNzMxLTExNTE6NTU6NTU=
...
SUBROUTINE OC.UPD.BUY.NAME2(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
*-----------------------------------------------------------------------------
*<Routine description>
*
* Populate the value only when MIFID.REPORT.STATUS as "NEWT".
* Attached as a link routine in TX.TXN.BASE.MAPPING record to
* If NATIONAL.ID is populated in field BUYER.ID then fetch NAME.2 from CUSTOMER table for the counterparty
* Incoming parameters:
*
