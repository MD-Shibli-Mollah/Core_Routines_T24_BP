* @ValidationCode : MjoxODgwMzk4Nzg5OkNwMTI1MjoxNTg2NDMzNjg4MzQzOnBhdml0aHJhc3JpOjE6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDIuMjAyMDAxMTctMjAyNjo5NDo2OQ==
...
SUBROUTINE E.CL.ROLL.FWD.DELIQUENT(VALUES.LIST)
*------------------------------------------------------------------------
    ...
    WHILE CL.ITEM:Y.POS
        ...
        LOCATE FROM.DATE IN R.CL.ITEM.BUCKET<CL.Contract.ItemBucket.BkBucketDate,1> BY "AL" SETTING BUC.DATE.POS THEN
            ...
            IF BUC.DATE.POS EQ TOT.CNT.BUC.DATE THEN
                ...
                IF CURRENT.BUCKET AND CURRENT.BUCKET GT PREVIOUS.BUCKET THEN
                    GOSUB TOTAL
