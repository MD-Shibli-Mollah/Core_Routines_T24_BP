* @ValidationCode : MjoyODQxMjkzOTM6Q3AxMjUyOjE1OTk2NDUwOTM1Mzc6a2JoYXJhdGhyYWo6ODowOjA6MTpmYWxzZTpOL0E6REVWXzIwMjAwOC4yMDIwMDczMS0xMTUxOjc2OjY5
* @ValidationInfo : Timestamp         : 09 Sep 2020 15:21:33
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : kbharathraj
* @ValidationInfo : Nb tests success  : 8
* @ValidationInfo : Nb tests failure  : 0
* @ValidationInfo : Rating            : N/A
* @ValidationInfo : Coverage          : 69/76 (90.7%)
...
SUBROUTINE OC.UPD.SELL.ID(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
*-----------------------------------------------------------------------------
*<Routine description>
*
* Populate the value only when MIFID.REPORT.STATUS as "NEWT".
* Attached as a link routine in TX.TXN.BASE.MAPPING record to
* If transaction is SELL - LEI code of the bank
* If transaction in BUY - Counterparty's LEGAL.ENTITY Id from OC.CUSTOMER, if not present fetch NATIONAL.ID
*
* Incoming parameters:
*
