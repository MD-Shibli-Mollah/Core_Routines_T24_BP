...
*-----------------------------------------------------------------------------
    ...
    SUBROUTINE OC.SELECT.DELEGATED.REPORTS(Y.ARG)
...
*The routine will return the output argument only when reporting model is '2'.
...
*Hence,the field positions were used instead of field names.
    ...
    IF EB.Utility.getCApplRec()<6> EQ '2' THEN
