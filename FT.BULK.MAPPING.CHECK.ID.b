...
*
    ...
    SUBROUTINE FT.BULK.MAPPING.CHECK.ID
************************************************************************
* ID validation
*
************************************************************************
...
CHECK.ID:
    ...
    READ.ERR = ''
    R.TAB.DEF = EB.SystemTables.TableDefinition.Read(EB.SystemTables.getIdNew(), READ.ERR)
    IF READ.ERR THEN
        EB.SystemTables.setE('FT-DYN.TEMPLATE.NOT.DEFINED')
    END
