...
*-----------------------------------------------------------------------------
    $PACKAGE LC.Contract
      SUBROUTINE CONV.LETTER.OF.CREDIT.14.2B
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.LETTER.OF.CREDIT"       ; * File to be converted
      COMPANY.CODE.POS = "137"           ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "107"             ; * Position to add from. (New field number)
...
*
      ...
      ETEXT ="LC.RTN.WHY.PROGRAM.ABORTED.17"       ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
