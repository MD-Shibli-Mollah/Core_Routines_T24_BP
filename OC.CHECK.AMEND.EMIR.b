* @ValidationCode : MjoxMTkwNjIyMTE2OkNwMTI1MjoxNTk5NDc2MjM3ODMxOmtiaGFyYXRocmFqOjU6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDguMjAyMDA3MzEtMTE1MTo3NDo2NA==
* @ValidationInfo : Timestamp         : 07 Sep 2020 16:27:17
...
SUBROUTINE OC.CHECK.AMEND.EMIR(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
...
*The purpose of the routine is to check whether the user amend the deal only in action type field.
*Then it will produce OC.TRADE.DATA.
    ...
    BEGIN CASE
        CASE APPL.ID[1,2] EQ "ND"
            ...
            IF NdDealRec NE '' THEN
                ...
                IF (ActionType NE NdDealRec<FX.Contract.NdDeal.NdDealActionType>) AND (MifidReportStatus EQ NdDealRec<FX.Contract.NdDeal.NdDealMifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
        ...
        CASE APPL.ID[1,2] EQ "SW"
            ...
            IF SwDealRec NE '' THEN
                ...
                IF (ActionType NE SwDealRec<SW.Contract.Swap.ActionType>) AND (MifidReportStatus EQ SwDealRec<SW.Contract.Swap.MifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
        ...
        CASE APPL.ID[1,2] EQ "FR"
            ...
            IF FrDealRec NE '' THEN
                ...
                IF (ActionType NE FrDealRec<FR.Contract.FraDeal.FrdActionType>) AND (MifidReportStatus EQ FrDealRec<FR.Contract.FraDeal.FrdMifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
        ...
        CASE APPL.ID[1,2] EQ "DX"
            ...
            IF DxDealRec NE '' THEN
                ...
                IF (ActionType NE DxDealRec<DX.Trade.Trade.TraActionType>) AND (MifidReportStatus EQ DxDealRec<DX.Trade.Trade.TraMifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
        ...
        CASE APPL.ID[1,2] EQ "FX"
            ...
            IF FxDealRec NE '' THEN
                ...
                IF (ActionType NE FxDealRec<FX.Contract.Forex.ActionType>) AND (MifidReportStatus EQ FxDealRec<FX.Contract.Forex.MifidReportStatus>) THEN
                    RET.VAL = 1
                END ELSE
                    RET.VAL = 0
                END
