...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.SECTOR"                 ; * File to be converted
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 3                 ; * Position to add from. (New field number)
...
*
      ...
      ETEXT ="EB.RTN.WHY.PROGRAM.ABORTED.16"       ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
