...
*-----------------------------------------------------------------------------
    $PACKAGE PC.Contract
    SUBROUTINE CONV.CONSOLIDATE.COND.G132.PC
**************************************************************************
...
*
    IF PC.INSTALLED THEN
        ...
        WHILE ID:YID
            ...
            R.CONVERSION<EB.CONV.OLD.CO.CODE.POS> = "40"
            R.CONVERSION<EB.CONV.NEW.CO.CODE.POS> = "44"
            R.CONVERSION<EB.CONV.RE.RUN.FLAG> = "YES"
            R.CONVERSION<EB.CONV.ADD.FIELD.START> = "7"
            R.CONVERSION<EB.CONV.ADD.FIELD.NO> = "4"
