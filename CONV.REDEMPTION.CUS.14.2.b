...
*-----------------------------------------------------------------------------
    $PACKAGE SC.SccClassicCA
      SUBROUTINE CONV.REDEMPTION.CUS.14.2
*
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,2> = "12"              ; * Position to add from. (New field number)
      ADD.FIELD<2,2> = "1"               ; * Number of fields to add.
      ADD.FIELD<1,1> = "34"              ; * Position to add from. (New field number)
