...
*
    $PACKAGE DX.Trade
      SUBROUTINE CONV.DX.TRANSACTION.R08(DX.TRANSACTION.ID,R.DX.TRANSACTION,FN.DX.TRANSACTION)
*-----------------------------------------------------------------------------
...
* Change data for field EVENT.TYPE
      ...
      eventCodeList = R.DX.TRANSACTION<eventFldPos>
      ...
      FOR eventCodeNo = 1 TO eventCodeCount
         ...
         R.DX.TRANSACTION<eventFldPos,eventCodeNo> = eventCode
      NEXT eventCodeNo

* Change data for field ACT.EVENT.TYPE

      eventCodeList = R.DX.TRANSACTION<eventFldPosTwo>
      eventCodeCount = DCOUNT(eventCodeList,VM)

      FOR eventCodeNo = 1 TO eventCodeCount
         eventCode = eventCodeList<1,eventCodeNo>
         GOSUB MODIFY.EVENT.CODE
         R.DX.TRANSACTION<eventFldPosTwo,eventCodeNo> = eventCode
      NEXT eventCodeNo
