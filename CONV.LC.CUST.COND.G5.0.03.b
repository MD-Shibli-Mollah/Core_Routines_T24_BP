...
*-----------------------------------------------------------------------------
    $PACKAGE LC.Foundation
      SUBROUTINE CONV.LC.CUST.COND.G5.0.03
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.LC.CUSTOMER.CONDITION"  ; * File to be converted
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "8"               ; * Position to add from. (New field number)
...
*
      ...
      ETEXT ="LC.RTN.WHY.PROGRAM.ABORTED.8"        ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
