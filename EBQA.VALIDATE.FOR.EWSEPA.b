* @ValidationCode : Mjo5NjIzODk1NzE6Q3AxMjUyOjE1OTg5NjcwODE2ODU6amF5YXNocmVldDo0OjA6MDoxOmZhbHNlOk4vQTpERVZfMjAyMDA3LjIwMjAwNzAxLTA2NTc6OTI6Nzc=
* @ValidationInfo : Timestamp         : 01 Sep 2020 19:01:21
...
SUBROUTINE EBQA.VALIDATE.FOR.EWSEPA
*-------------------------------------------------------------------------------------------------------------
*
* This is a new api to perform clearing specific validation for EWSEPA payments.
* Validation checked for outgoing camt.056 and camt.029 messages.
*
*-------------------------------------------------------------------------------------------------------------
* Modification History :
*--------------------------------------------------------------------------------------------------------------
* 01/09/2020 - Enhancement 3831744 / Task 3910362 - clearing specific validation for EWSEPA payments.
*            
*-------------------------------------------------------------------------------------------------------------
