...
*-----------------------------------------------------------------------------
    $PACKAGE PC.Contract
    SUBROUTINE CONV.COMPANY.R07.PC(Y.ID, R.PC.PERIOD, F.PC.PERIOD)
*-----------------------------------------------------------------------------
* This conversion will introduce three new fields at 67, 68 and 69 in
* COMPANY.PC<<pc.period>> records. This is copy of what the core actual
* conversion CONV.COMPANY.R07 will do.
*
...
*   to do the actual conversion.
    ...
    R.CONVERSION<EB.CONV.OLD.CO.CODE.POS> = "72"
    R.CONVERSION<EB.CONV.NEW.CO.CODE.POS> = "75"
    R.CONVERSION<EB.CONV.RE.RUN.FLAG> = "YES"
    R.CONVERSION<EB.CONV.ADD.FIELD.START> = "67"
    R.CONVERSION<EB.CONV.ADD.FIELD.NO> = "3"
