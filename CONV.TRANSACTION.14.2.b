...
*-----------------------------------------------------------------------------
    $PACKAGE ST.Config
      SUBROUTINE CONV.TRANSACTION.14.2
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.TRANSACTION"            ; * File to be converted
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "18"              ; * Position to add from. (New field number)
...
*
      ...
      ETEXT ="AC.RTN.WHY.PROGRAM.ABORTED.8"        ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
