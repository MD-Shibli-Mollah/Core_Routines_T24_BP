...
*-----------------------------------------------------------------------------
    ...
    SUBROUTINE E.MB.BUILD.CR.LATEST.DATE(ENQ.DATA)
*-----------------------------------------------------------------------------
...
*  Primary Purpose : To get a latest record of a given Account from a file STMT.ACCT.CR
...
* Form @ID with Account No and latest capitalisation date
    ...
    Y.DATE = R.ACCOUNT<AC.AccountOpening.Account.CapDateCrInt,1>                           ;*Get the latest date from account
