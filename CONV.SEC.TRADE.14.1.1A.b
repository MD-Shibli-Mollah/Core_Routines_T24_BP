...
* Version 5 12/06/01  GLOBUS Release No. 200512 09/12/05
*-----------------------------------------------------------------------------
* <Rating>431</Rating>
*-----------------------------------------------------------------------------
    $PACKAGE SC.SctTrading
      SUBROUTINE CONV.SEC.TRADE.14.1.1A
*
*     Last updated by Andreas (dev) at 13:41:47 on 05/12/94
*
* THIS CONVERSION PROGRAM IS ONLY FOR 'BDG' AND NOWHERE ELSE.
* MUST BE RUN ONLY ONCE AND BEFORE ANY TRANSACTIONS HAVE BEEN
* ENTERED.
*
...
*
      ...
      CLS := @(0,4)
      YFILE = "F.SEC.TRADE"
*      COMPANY.CODE.POS = 15             ;* Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ADD.FIELD = ''
*      ADD.FIELD<1,1> = 2        ;* Position to add from. (New field number)
