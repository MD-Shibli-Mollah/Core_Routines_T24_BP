...
*-----------------------------------------------------------------------------
    ...
    SUBROUTINE CONV.MM.PAYMT.ENTRY.14.2
*
...
*
    ...
    NEXT X
    CLS := @(0,4)
    YFILE = "F.MM.PAYMENT.ENTRY"        ;* File to be converted
    COMPANY.CODE.POS = 40     ;* Position of new XX.CO.CODE in the file
    F.PGM.FILE = ''
...
** file is being converted more than once.
    ADD.FIELD = ''
    ADD.FIELD<1,1> = 25       ;* Position to add from. (New field number)
