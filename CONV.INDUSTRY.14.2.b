...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.INDUSTRY"               ; * File to be converted
      COMPANY.CODE.POS = 13              ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ...
      ETEXT ="EB.RTN.WHY.PROGRAM.ABORTED.14"       ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
