...
* Version 3 25/05/01  GLOBUS Release No. 200511 31/10/05
    ...
    SUBROUTINE CONV.STANDING.ORDER.14.2
*
...
*
    ...
    NEXT X
    CLS := @(0,4)
    YFILE = "F.STANDING.ORDER"         ; * File to be converted
...
*
    ADD.FIELD = ''
    ADD.FIELD<1,1> = 39                ; * Position to add from.
    ADD.FIELD<2,1> = 10                ; * Number of fields to add.
*
    VALUE.FIELD = ''
    VALUE.FIELD<41> = 16               ; * $Value or old field number.
*
*************************************************************************
*
            ...
            READ YREC FROM F.FILE, YID ELSE GOTO FATAL.ERROR
                ...
                END ELSE
                    ...
                    *
                    ...
                    REPEAT
                    *
                    ** Value the fields specified here
                    *
                    IF YREC<2>[1,2] = "AC" THEN  ; * Only for AC
                        YREC<41> = YREC<16>       ; * Ben Acct No
                        YREC<16> = ""             ; * Blank out
                    END
                    *
