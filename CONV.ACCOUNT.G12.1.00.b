...
*-----------------------------------------------------------------------------
      ...
      SUBROUTINE CONV.ACCOUNT.G12.1.00
*
...
*             Clear fields 124 through 126 of records in Fxxx.ACCOUNT.xxx files.
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.ACCOUNT"                ; * File to be converted
...
*
      ...
      ETEXT ="EB.RTN.WHY.PROGRAM.ABORTED"          ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
