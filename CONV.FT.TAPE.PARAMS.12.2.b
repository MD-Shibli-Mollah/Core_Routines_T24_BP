...
* Version 8 15/05/01  GLOBUS Release No. 200511 31/10/05
    ...
    $PACKAGE FT.Clearing
      SUBROUTINE CONV.FT.TAPE.PARAMS.12.2
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.FT.TAPE.PARAMS"         ; * File to be converted
      COMPANY.CODE.POS = 26              ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
            ...
            REPEAT
*
            YREC<FT.TP.DIRECTION> = 'INWARD'       ; * Default direction to inward
            YREC<FT.TP.ENQUIRY.FILE.DAYS> = '5'    ; * Default no of days on enquiry file
*
