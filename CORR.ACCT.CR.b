...
*-----------------------------------------------------------------------------
    ...
    SUBROUTINE CORR.ACCT.CR
REM "CORR.ACCT.CR",850725-001,"MAINPGM"
*
* GB9400210- 09-05-94
...
*
* 23-11-00 - GB0002986 - PJG
*            Add new fields as part of the enhancements for German
*            Withholding Tax.
*
* 04/04/01 - GB0100940
...
*************************************************************************
REM "DEFINE PGM NAME (BY USING 'C/CORR.ACCT.CR/.../G9999')
*========================================================================
...
* checkfile "ACCOUNT":FM:AC.CUSTOMER:FM:FM:"CUSTOMER":FM:EB.CUS.SHORT.NAME separately
    ...
    IC.InterestAndCapitalisation.StmtAcctCrFields()

*
    EB.SystemTables.setPrefix("IC.CORCR")
*========================================================================
...
* cancel '.' (part of mask only)
    COMI2 = FIELD(COMI.VAL,"-",EB.SystemTables.getIdT()<7>,99)
    EB.SystemTables.setComi(FIELD(COMI.VAL,"-",EB.SystemTables.getIdT()<7>-1))
