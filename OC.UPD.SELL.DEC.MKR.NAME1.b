* @ValidationCode : MjotMTUzNjc4NDkyOTpDcDEyNTI6MTU5OTY0NTA4NzI2MTprYmhhcmF0aHJhajo1OjA6MDoxOmZhbHNlOk4vQTpERVZfMjAyMDA4LjIwMjAwNzMxLTExNTE6NTQ6NTQ=
* @ValidationInfo : Timestamp         : 09 Sep 2020 15:21:27
...
SUBROUTINE OC.UPD.SELL.DEC.MKR.NAME1(APPL.ID,APPL.REC,FIELD.POS,RET.VAL)
*-----------------------------------------------------------------------------
*<Routine description>
*
* Populate the value only when MIFID.REPORT.STATUS as "NEWT".
* Attached as a link routine in TX.TXN.BASE.MAPPING record to
* If NATIONAL.ID is populated in field SELLER.DECISION.MKR then fetch NAME.1 from CUSTOMER table for the DecisionMkrId.
* Incoming parameters:
*
