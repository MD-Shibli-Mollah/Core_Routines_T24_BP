...
* Version 5 18/05/01  GLOBUS Release No. 200511 31/10/05
*-----------------------------------------------------------------------------
* <Rating>531</Rating>
*-----------------------------------------------------------------------------
    $PACKAGE AC.Config
      SUBROUTINE CONV.ACCOUNT.PARAMETER.14.1
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.ACCOUNT.PARAMETER"      ; * File to be converted
      COMPANY.CODE.POS = 21              ; * Position of XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ADD.FIELD = ''
      ADD.FIELD<1,1> = 10                ; * Position to add from.
