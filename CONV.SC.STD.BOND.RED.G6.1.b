...
*-----------------------------------------------------------------------------
    $PACKAGE SC.SccClassicCA
      SUBROUTINE CONV.SC.STD.BOND.RED.G6.1
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.SC.STD.BOND.RED"        ; * File to be converted
      COMPANY.CODE.POS = "41"            ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
** file is being converted more than once.
      ...
      ADD.FIELD<2,1> = "13"              ; * Number of fields to add.
*
*************************************************************************
*
