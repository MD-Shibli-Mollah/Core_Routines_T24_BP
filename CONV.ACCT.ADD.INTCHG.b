...
*-----------------------------------------------------------------------------
    $PACKAGE IC.InterestAndCapitalisation
      SUBROUTINE CONV.ACCT.ADD.INTCHG
*
...
*
      ...
      COMPANY.CODE.POS = "400"           ; * Position of new XX.CO.CODE in the file
      F.PGM.FILE = ''
...
*
      ...
      TEXT = ""
      FOR FILE.TYPE = 1 TO 1             ; * only go through live file
         BEGIN CASE
            CASE FILE.TYPE EQ 1
               SUFFIX = ""
            CASE FILE.TYPE EQ 2
...
*
            IF YREC<72> THEN
               ...
               V$INT = YREC<52,1>:YREC<56,1>:YREC<60,1>:YREC<64,1>:YREC<68,1>
               ...
               IF V$INT THEN
                  ...
                  PARAMS<2> = YID
                  YTYPE = '51000'
                  CALL RE.UPDATE.LINK.FILE(PARAMS, YTYPE)
               END
            END
