...
INITIALISE:
    ...
    IF EB.SystemTables.getRNew(LC.Config.AdviceText.TfAdNarrative) NE '' AND EB.SystemTables.getVFunction() EQ 'I' THEN

        EB.SystemTables.setRNew(LC.Config.AdviceText.TfAdNarrative, '')
