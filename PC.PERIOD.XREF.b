...
DEFINE.PARAMETERS:
    ...
    EB.SystemTables.setIdF('COMPANY.CODE'); EB.SystemTables.setIdN('11.1'); tmp=EB.SystemTables.getIdT(); tmp<1>='COM'; EB.SystemTables.setIdT(tmp)
    tmp=EB.SystemTables.getIdT(); tmp<4>=''; EB.SystemTables.setIdT(tmp); EB.SystemTables.setIdConcatfile('AR')
    EB.SystemTables.setIdCheckfile('COMPANY':@FM:ST.CompanyCreation.Company.EbComCompanyName:@FM:'L..S')

    Z += 1 ; EB.SystemTables.setF(Z, "XX.PERIOD.END"); EB.SystemTables.setN(Z, "11..C"); tmp=EB.SystemTables.getT(Z); tmp<1>='D'; EB.SystemTables.setT(Z, tmp)
    ...
    EB.SystemTables.setV(Z + 9); EB.SystemTables.setPrefix('PC.XREF')
