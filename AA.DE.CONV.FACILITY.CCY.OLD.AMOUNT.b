* @ValidationCode : MjoxNDQ1MzgzOTk4OkNwMTI1MjoxNjA4NjIyOTI5NzYwOmRpdnlhc2FyYXZhbmFuOjE6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDYuMjAyMDA1MjEtMDY1NTo0NjoxMg==
* @ValidationInfo : Timestamp         : 22 Dec 2020 13:12:09
...
SUBROUTINE AA.DE.CONV.FACILITY.CCY.OLD.AMOUNT(InValue, HeaderRec, MvNo, OutValue, ErrorMsg)
*-----------------------------------------------------------------------------
*
...
DoProcess:
    ...
    DeMsgFldName = 'OLD EXCH RATE'
    GOSUB GetFieldValue
    OldExchangeRate = DeMsgFieldData
...
* Convert the incoming amount from Drawing Ccy to Facility Ccy
    ...
    OutCurrency = ''
    UtilisationAmount = ''
    AA.Framework.ConvertFacilityCcyAmount(ArrangementId, InAmount, EffectiveDate, OldExchangeRate, '', OutCurrency, OutAmount, LocalAmount, UtilisationAmount, RetError)
