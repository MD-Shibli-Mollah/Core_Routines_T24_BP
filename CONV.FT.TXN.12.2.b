...
*
    ...
    NEXT X
    CLS := @(0,4)
    YFILE = "F.FT.TXN.TYPE.CONDITION"   ;* File to be converted
    COMPANY.CODE.POS = 32     ;* Position of XX.CO.CODE in the file
    F.PGM.FILE = ''
...
*
    ADD.FIELD = ''
    ADD.FIELD<1,1> = 21       ;* Position to add from.
