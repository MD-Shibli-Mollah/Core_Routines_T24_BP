...
*-----------------------------------------------------------------------------
    $PACKAGE LC.Config
      SUBROUTINE CONV.LC.TXN.TYPE.CON.14.2
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.LC.TXN.TYPE.CONDITION"  ; * File to be converted
...
** file is being converted more than once.
      ADD.FIELD = ''
      ADD.FIELD<1,1> = "7"               ; * Position to add from. (New field number)
      ADD.FIELD<2,1> = "9"               ; * Number of fields to add.
*
*************************************************************************
*
...
*
      ...
      ETEXT ="LC.RTN.WHY.PROGRAM.ABORTED.13"       ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
