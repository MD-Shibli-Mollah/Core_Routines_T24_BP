* @ValidationCode : MjoxNzc4NjEwODMzOkNwMTI1MjoxNjA0ODM3NDk5Mjk4OnJkZWVwaWdhOjE6MDowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIwMDkuMjAyMDA4MjgtMTYxNzo2OjY=
...
SUBROUTINE SCDX.TRS.UPD.ORIGINATE(TXN.ID,TXN.REC,TXN.DATA,RET.VAL)
*-----------------------------------------------------------------------------
* This routine to update the ORIGINATE.SYSTEM as TEMENOS in SCDX.ARM.MIFID.DATA
...
*-----------------------------------------------------------------------------
    ...
    GOSUB PROCESS       ; *Process to update the ORIGINATE.SYSTEM as TEMENOS for SCDX.ARM.MIFID.DATA reports
...
*** <region name= PROCESS>
PROCESS:
*** <desc>Process to update the ORIGINATE.SYSTEM as TEMENOS for SCDX.ARM.MIFID.DATA reports </desc>
