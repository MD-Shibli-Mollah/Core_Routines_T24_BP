...
*-----------------------------------------------------------------------------
    $PACKAGE EB.SystemTables
      SUBROUTINE CONV.DEPT.ACCT.OFFICER.G7
*
...
*
      ...
      NEXT X
      CLS := @(0,4)
      YFILE = "F.DEPT.ACCT.OFFICER"      ; * File to be converted
      ORIGINAL.FILE = YFILE              ; * Store this it will changed
      COMPANY.CODE.POS = "24"            ; * Position of new XX.CO.CODE in the file
...
** file is being converted more than once.
      ...
      ADD.FIELD<2,2> = "4"               ; * Number of fields to add.
*
*************************************************************************
*
...
*
      ...
      ETEXT ="EB.RTN.WHY.PROGRAM.ABORTED.3"        ; * Used to update F.CONVERSION.PGMS
      CALL PGM.BREAK
*
*************************************************************************
   END
